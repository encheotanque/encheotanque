...
[ BANCO DE DADOS (Oracle MySQL) ]
 └── Retro-Alimentado assincronamente por Robôs Python (Processador NFC-e estatais).
        </div>
        ...
        <div class="pitch-box">
            <h3>🎤 ROTEIRO DE APRESENTAÇÃO E PITCH DA BANCA</h3>
            ...
            "Boa noite a todos! Todo mundo aqui já sofreu pra achar um posto barato confiavel, ou abasteceu num valor alto e logo na rua de baixo viu outro mais barato. A dor é clara: nós somos cegos para os preços predatórios do mercado da gasolina. Nossa solução? O 'Enche o Tanque'. Não somos um app de listinhas, nós construímos um <strong>radar financeiro</strong> da cidade em tempo real."</p>

            <p><strong>[Parte 2: A Solução Tecnológica Cidadão - 1.5min]</strong><br>
            "O pilar disso são os QR Codes - o quadradinho que já vem nas Notas Fiscais que todos nós costumávamos jogar no lixo. O cidadão abastece e, com um click, doa a nota fiscal pra nossa base. O App absorve esses dados lá no servidor da Fazenda (SEFAZ), transformando aquele papel rasgado em Dados Vivos no nosso banco de dados da Oracle."</p>

            <p><strong>[Parte 3: Apresentando o Produto (Demo) - 1.5min]</strong><br>
            <em>(Momento da equipe mostrar o aplicativo rodando no raio de de 5 a 20km)</em><br>
            "E como a gente entrega visualmente essa inteligência? Com Matemática Pura. Nós renderizamos o município de Petrópolis inteiro aplicando uma interpolação RGB Haversine. Ao redor do seu GPS, os pinos dos postos reagem de cor: do Escarlate pro posto abusivo... até o Verde Esmeralda dos melhores preços de mercado daquele dia. E claro, o nosso radar coroa o posto absolutamente mais barato da cidade brilhando em Ouro com um Troféu Gigante! Você clica no Ouro, e o botão azul leva você pelo Google Maps direto pra bomba pra economizar nos próximos 5 minutos."</p>

            <p><strong>[Parte 4: Escalabilidade pra 100.000 usuários (Pitch Frotas) - 1.5min]</strong><br>
            "Tudo isso é lindo para o consumidor. Mas como a gente monetiza e escala esse negócio pra base enriquecer brutalmente em semanas? É o que faremos terça-feira migrando a tela para o Mercado Frotista B2B.<br><br>Migraremos a arquitetura adicionando Empresas, Frotas de Veículos e Motoristas. O Dono da Transportadora vai exigir que seus 300 Motoristas batam a NFC-e no <em>Enche o Tanque</em> a cada parada pra que a empresa re-embolse. De uma vez só: salvamos o lucro gigantesco da Transportadora e em troca, recebemos <strong>milhares de preços atualizados pra rede inteira de graça, sem esforço de marketing.</strong><br><br>Conectividade direta de logística, resolvendo problemas de mercado... Muito Obrigado."</p>
        </div>
...
async function makeHtml() {
    try {
        const publicDir = path.join(process.cwd(), 'app', 'applet', 'public');
